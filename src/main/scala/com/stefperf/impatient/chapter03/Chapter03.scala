package com.stefperf.impatient.chapter03
...
object Chapter03 extends Chapter(3, "Working with Arrays", Level.A1) {
  ...
  override def exercises() {
    ...
    exercise(11) {
      ...
      val nativesForImageFlavor: collection.Map[java.awt.datatransfer.DataFlavor, String] =
        mapAsScalaMap(flavors.getNativesForFlavors(Array(DataFlavor.imageFlavor)))
